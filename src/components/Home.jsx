...
const Home = () => {
  const categories = [
    { title: "New In", image: categoryc1, link: "/new-in" },
  ...
  return (
    <>
      <div className="mt-[80px] relative w-full h-[60vh] md:h-[80vh] lg:h-[100vh]">
        ...
        >
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-2 leading-tight drop-shadow-lg">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 max-w-7xl mx-auto px-4">
          {categories.map((cat, index) => (
            <a
              key={index}
              href={cat.link}
              className="group block overflow-hidden rounded-xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-2xl"
            >
              <img
                src={cat.image}
                alt={cat.title}
              ...
              <div className="p-4 bg-white">
                ...
                <div className="mt-4 flex justify-center">
                  <a
                    href={cat.link}
                    className="text-green-800 font-medium border-b-2 border-green-600 hover:text-green-600 transition-colors"
                  >
                    SHOP NOW
                  </a>
                </div>
